...
| Path | Description |
| --- | --- |
| `weights/epoch_160.pth` | Trained checkpoint specified for submission. Download from the external link below. |
...
```text
https://pan.quark.cn/s/840b0e6c788b
Extraction code: tCVp
```

Because this file is larger than GitHub's 100 MB regular file limit, the checkpoint is provided through the external download link above. After downloading it, place the file at:
